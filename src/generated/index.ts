...
export type CreateAchievementMutation = { __typename?: 'Mutation', createAchievement: { __typename?: 'Achievement', _id: string, description: string, icon?: string | null, threshold: number, title: string } };
